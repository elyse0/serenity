...
JS_DEFINE_NATIVE_FUNCTION(MathObject::atanh)
{
    ...
    return Value(::atanh(number_double));
}
...
JS_DEFINE_NATIVE_FUNCTION(MathObject::log1p)
{
    ...
    return Value(::log1p(number_double));
}
...
JS_DEFINE_NATIVE_FUNCTION(MathObject::atan2)
{
    ...
    if (y.as_double() > 0) {
        ...
        // c. If nx is +0𝔽 or nx is -0𝔽, return an implementation-approximated Number value representing π / 2.
...
JS_DEFINE_NATIVE_FUNCTION(MathObject::log)
{
    ...
    return Value(::log(number_double));
}
...
JS_DEFINE_NATIVE_FUNCTION(MathObject::log2)
{
    ...
    return Value(::log2(number_double));
}
...
JS_DEFINE_NATIVE_FUNCTION(MathObject::log10)
{
    ...
    return Value(::log10(number_double));
}
