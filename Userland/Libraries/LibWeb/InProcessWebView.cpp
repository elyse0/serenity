...
void InProcessWebView::keydown_event(GUI::KeyEvent& event)
{
    ...
    if (event.modifiers() == 0) {
        ...
        case Key_End:
            ...
            break;
        case Key_Down:
            vertical_scrollbar().go_up_in_steps(1);
            break;
        case Key_Up:
            vertical_scrollbar().go_down_in_steps(1);
            break;
        case Key_Left:
            horizontal_scrollbar().go_up_in_steps(1);
            break;
        case Key_Right:
            horizontal_scrollbar().go_down_in_steps(1);
            break;
        case Key_PageDown:
            vertical_scrollbar().go_up(frame_inner_rect().height());
            break;
        case Key_PageUp:
            vertical_scrollbar().go_down(frame_inner_rect().height());
            break;
        default:
